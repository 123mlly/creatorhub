...
本地运行的多平台内容管理面板，支持 **抖音 / 小红书 / 快手 / 视频号 / YouTube / TikTok**。

基于 Python + FastAPI 提供 Web 界面，也可通过桌面壳（pywebview）或 Docker 运行。账号登录态、数据库与媒体文件保存在本机，不上传云端。

## 平台能力

| 功能 | 抖音 | 小红书 | 快手 | 视频号 | YouTube | TikTok |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| 登录 | 扫码 / 创作者 / Cookie | 扫码 / Cookie | 扫码 / 创作者 / Cookie | 扫码 / Cookie | 扫码 / Cookie | 扫码 / Cookie |
| 作品监控与下载 | ✅ 可选画质 | ✅ 创作者 / 关键词 | ✅ | 仅本账号 | ✅ 需登录账号 | ✅ 需登录账号 |
| 直播监控与录制 | ✅ 开播提醒 + 录 mp4 | — | — | — | ✅ 开播提醒 + 录 mp4 | — |
| 评论监控 | ✅ | ✅ | ✅ | 仅本账号 | — | — |
| 发布 | ✅ | ✅ | ✅ | ✅ | ✅ Studio | ✅ Studio |
| 自动评论 | ✅ | ✅ | ✅ | — | — | — |
| 本账号 | 作品 / 关注 / 粉丝 / 私信 | 作品 / 关注 / 粉丝 / 私信 | 作品 / 关注 / 粉丝 | 作品 / 数据 | 作品 / 数据 | 作品 / 数据 |
| 通知 | Bark / 钉钉 / Telegram | 同左 | 同左 | 同左 | 同左 | 同左 |

说明：

- **视频号**：仅创作者助手中的本账号数据，不支持监控或下载他人作品。
- **YouTube**：监控与下载依赖已登录账号（yt-dlp + Cookie）；暂无评论监控、关注/粉丝/私信；Studio 发布需本机弹出浏览器，Docker 中受限。
- **TikTok**：监控与下载依赖已登录账号（yt-dlp + Cookie）；暂无评论监控、直播、关注/粉丝/私信；Studio 发布需本机弹出浏览器，遇验证码请在弹出窗口里手动处理。
...
TikTok 建议用浏览器登录或粘贴含 `sessionid` 的完整 Cookie；监控目标需要绑定已登录的 TikTok 账号。

### 监控与下载

- **作品监控**：创作者主页、作品链接、短链或平台 ID；发现新作自动入库。
- **评论监控**：单条作品或账号近期作品（YouTube / TikTok / 视频号他人作品不适用）。
...
| TikTok 监控失败 | 确认已添加并登录 TikTok 账号，Cookie 需含 `sessionid` / `sid_tt` |
